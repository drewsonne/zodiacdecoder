 // z340GA.cpp - MAIN FILE FOR OUR ZODIAC 340 GENETIC ALGORITHM CLIENT
...
/////
// main() FUNCTION FOR GENETIC ALGORITHM PROGRAM
//
//
//
/////
...
void Defaults(int &CIPHER_SIZE, int &CIPHER_WIDTH, int &CIPHER_HEIGHT, int &KEY_SIZE, int &NUM_KEYS, int &GENERATIONS, bool &LOGWEIGHT, string &CIPHER_FILE, double &BI_BONUS, double &TRI_BONUS, double &TETRA_BONUS, double &PENTA_BONUS, double &SURVIVAL_RATE, double &BREED_RATE, double &MUTATE_RATE)
{
	/////
...
void Simulate(int NUM_KEYS, string CIPHER_FILE, int CIPHER_SIZE, int KEY_SIZE, int GENERATIONS, int CIPHER_HEIGHT, int CIPHER_WIDTH, double SURVIVAL_RATE, double BREED_RATE, double MUTATE_RATE, double BI_BONUS, double TRI_BONUS, double TETRA_BONUS, double PENTA_BONUS)
{
	keyType bestKey;
...
void Simulations(int NUM_KEYS, string CIPHER_FILE, int CIPHER_SIZE, int KEY_SIZE, int GENERATIONS, int CIPHER_HEIGHT, int CIPHER_WIDTH, double SURVIVAL_RATE, double BREED_RATE, double MUTATE_RATE, double BI_BONUS, double TRI_BONUS, double TETRA_BONUS, double PENTA_BONUS)
{
	int SIMULATIONS;
...
void ReadCipher(string CIPHER_FILE, int CIPHER_SIZE, int KEY_SIZE)
{
	int index = 0;
...
void InitializeKeys(int NUM_KEYS, int KEY_SIZE)
{
	time_t seconds;
	time(&seconds);
...
void SolveKeys(int NUM_KEYS, int KEY_SIZE, int CIPHER_SIZE)
{
...
void ScoreKeys(int NUM_KEYS, int CIPHER_SIZE, int KEY_SIZE, keyType & bestKey, double BI_BONUS, double TRI_BONUS, double TETRA_BONUS, double PENTA_BONUS)
{
	string word = "";
	string solution = "";
...
void MateAndMutate(int NUM_KEYS, int KEY_SIZE, double SURVIVAL_RATE, double BREED_RATE, double MUTATE_RATE)
{
	int donor;
	int mother; 
	int father; 
...
void PrintCipher(keyType key, int CIPHER_HEIGHT, int CIPHER_WIDTH, int KEY_SIZE)
{
	int s = 0;
	int l = 0;
